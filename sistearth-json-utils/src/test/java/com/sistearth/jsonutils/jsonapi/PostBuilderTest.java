...
public class PostBuilderTest extends JsonTest {
    ...
    public void testBuildMultiple() throws Exception {
        JSONAssert.assertEquals(
                "{'data':[{'relationships':{'author':{'data':{'type':'users','id':'5'}}},'attributes':{'created_at':'2016-02-01 00:00:00','title':'Foo','body':'Lorem ipsum'},'id':'0','type':'posts'},{'relationships':{'author':{'data':{'type':'users','id':'3'}}},'attributes':{'created_at':'2016-03-02 00:00:00','title':'Bar','body':'Dolor sit amet'},'id':'1','type':'posts'}],'included':[{'attributes':{'email':'jon@dot.com','username':'John'},'id':'5','type':'users'},{'attributes':{'email':'jane@dot.com','username':'Jane'},'id':'3','type':'users'}]}",
                jsonify(
                        new PostBuilder().build(
                                newArrayList(
                                        new Post("0", "Foo", "Lorem ipsum", new GregorianCalendar(2016, 1, 1).getTime(), "5"),
                                        new Post("1", "Bar", "Dolor sit amet", new GregorianCalendar(2016, 2, 2).getTime(), "3")
                                ),
                                newArrayList(
                                        new User("5", "John", "jonsecret", "jon@dot.com"),
